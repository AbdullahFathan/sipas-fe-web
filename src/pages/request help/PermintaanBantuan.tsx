  ...
  return (
    <MainLayout>
      <section className="ml-[20px] mt-[35px] mr-[20px]">
        ...
        <div className="h-[70px] w-full bg-light-yellow rounded-lg flex justify-between items-center px-5">
          <p className="font-bold text-2xl text-yellow">
        ...
        <div className="h-[70px] my-4 w-full bg-light-green rounded-lg flex justify-between items-center px-5">
        ...
        <div className="h-[70px] my-4 w-full bg-light-red rounded-lg flex justify-between items-center px-5">
